...
# Java + tools for apktool, jarsigner, zipalign
RUN apt-get update && \
...
# Android build-tools for zipalign and apksigner
...
COPY bot.py .
COPY signer.keystore /app/signer.keystore   # ab zaroori nahi, lekin rakh sakte ho
